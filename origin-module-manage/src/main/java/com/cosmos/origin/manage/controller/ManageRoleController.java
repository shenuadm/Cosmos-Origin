package com.cosmos.origin.manage.controller;

import com.cosmos.origin.common.aspect.ApiOperationLog;
import com.cosmos.origin.common.utils.PageResponse;
import com.cosmos.origin.common.utils.Response;
import com.cosmos.origin.manage.model.vo.role.AddRoleReqVO;
import com.cosmos.origin.manage.model.vo.role.DeleteRoleReqVO;
import com.cosmos.origin.manage.model.vo.role.FindRolePageListReqVO;
import com.cosmos.origin.manage.model.vo.role.UpdateRoleReqVO;
import com.cosmos.origin.manage.service.ManageRoleService;
...
@Tag(name = "Manage 角色模块")
@RequiredArgsConstructor
public class ManageRoleController {

    private final ManageRoleService roleService;
